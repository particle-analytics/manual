...
(function(global) {
    ...
    function() {
        ...
        var u, a, f = typeof history.pushState != "undefined",
            l = function(n, i) {
                ...
                return s.show(e.get(u).done(function(t) {
                    ...
                    var n = e(t),
                        ...
                        a = n.find(".book");
                    document.title = s.find("title").text();
                    var f = e("head");
                    f.find("link[rel=prev]").remove(), f.find("link[rel=next]").remove(), f.append(s.find("link[rel=prev]")), f.append(s.find("link[rel=next]"));
                    var l = e(".book").attr("class"),
                        c = e(".book-summary .summary").scrollTop();
                    a.toggleClass("with-summary", e(".book").hasClass("with-summary")), e(".book").replaceWith(a), e(".book").attr("class", l), e(".book-summary .summary").scrollTop(c), r.update(e("html")), o.recover(), h()
                }).fail(function(e) {
                    location.href = n
                }))
            },
            ...
            m = function() {
                ...
                }, e(document).on("click", ".navigation-prev", p), e(document).on("click", ".navigation-next", p), e(document).on("click", ".summary [data-path] a", p), e(window).resize(c), h()
            };
        return {
            init: m,
            goNext: d,
        ...
        var h = function(e) {
            var t;
            t = o.$book, l.init(), c.init(), u.init(), n.init(), r.init(), a.init(), s.init(e.fontSettings || {}), i.trigger("start", e)
        };
        return {
            start: h,
            events: i,
